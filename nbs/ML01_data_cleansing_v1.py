...
# %%
df_HhLevel = pd.read_stata("data/raw/Climate-2016/Data/Data/HhldLevel_KeyVariable.dta")
...
# %%
df_PSULevel = pd.read_stata("data/raw/Climate-2016/Data/Data/PSULevel_KeyVariable.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S01.dta", convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S02_1.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S02_1.dta", convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S02_2.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S02_2.dta", convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S03.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S04.dta", convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S05.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S06.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S06_4.dta",
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S07_1.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S07_2.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S08.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S09.dta", convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S10_1.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S10_2.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S10_3.dta")
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S11.dta",
                       convert_categoricals=False)
...
# %%
df_read = pd.read_stata("data/raw/Climate-2016/Data/Data/S12.dta", convert_categoricals=False)
...
# %%
df_kept.to_parquet('data/processed/01_Napel2016.parquet')
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S01.dta"), 
                        convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S02_1.dta"), 
                        convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S02_2.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S04.dta"),
                        convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S05.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S06.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S06_3.dta"),
                       convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S07_1.dta"),
                       convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S07_2.dta"),
                       convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S08.dta"),
                       convert_categoricals=False)
...
# %%
df_read['NewDiseaseCropPast25_Dummy'] = np.where(df_read['H01'] == 1, 1, 0)
df_read['NewInsectCropPast25_Dummy'] = np.where(df_read['H03'] == 1, 1, 0)
df_read['NewDiseaseLivestockPast25_Dummy'] = np.where(df_read['H05'] == 1, 1, 0)

df_read['HumanDiseaseIncreasePast25_Dummy'] = np.where(df_read['H07'] == 1, 1, 0)
df_read['HumanVetorDisIncreasePast25_Dummy'] = np.where(df_read['H09'] == 1, 1, 0)
df_read['HumanWaterDisIncreasePast25_Dummy'] = np.where(df_read['H10'] == 1, 1, 0)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S09.dta"),
                       convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S10_1.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S10_2.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S10_3.dta"))
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/S11.dta"), convert_categoricals=False)
...
# %%
df_read = pd.read_stata(os.path.join('data', 'raw', "Climate-2022/Data 2022/NCCS 2022/Data/Weight.dta"))
